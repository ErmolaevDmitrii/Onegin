...
all: OneginSort.o
	$(CC) $(CFLAGS) main.c StringFunctions.o StringArray.o OneginSort.o -o a

OneginSort.o: StringArray.o
	$(CC) $(CFLAGS) OneginSort.c -c

StringArray.o: StringFunctions.o
	$(CC) $(CFLAGS) StringArray.c -c
